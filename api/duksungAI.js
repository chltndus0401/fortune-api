...
export default async function handler(req, res) {
  ...
  try {
    ...
    const result = await ai.models.generateContent({
      ...
      config: {
        systemInstruction:
          "당신은 60년 경력의 사주풀이 전문가입니다. 사람들의 오늘 운세를 100글자 이내로 전해주세요. 운세는 정확하기보다는 읽었을 때 즐거울 수 있도록 부정적인 내용은 없어야 합니다. 마지막에 오늘 가지고 있으면 좋은 <오늘의 행운 아이템>을 추천해주세요. 사람마다 다양하게 추천해주세요.",
      },
    });
